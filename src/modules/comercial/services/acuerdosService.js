...
const acuerdosService = {
  ...
  getEstadoComercial: (acuerdoId) => apiClient.get(`/api/acuerdos/${acuerdoId}/estado-comercial`).then((res) => res.data),  ajustarCuota: (cuotaId, payload) => apiClient.put(`/api/comercial/cuotas/${cuotaId}/ajustar`, payload).then((res) => res.data),
  ...
  getHistorialAjustesAcuerdo: (acuerdoId) => apiClient.get(`/api/comercial/acuerdos/${acuerdoId}/historial-ajustes`).then((res) => res.data),  getSaldoComercialCliente: (clienteExternoId) => apiClient.get(`/api/clientes/${clienteExternoId}/saldo-comercial`).then((res) => res.data),
